...
The health panel shows real-time metrics with gradient bars and sparkline history:
...
```
  ◆ SYSTEM HEALTH ──────────────────────────────────────────────
    ...
    MEMORY ██████████████░░░░░░░░░░░░░░░░  62.1%  ▂▃▄▅▆▅▄▃
    DISK   ████████████████████░░░░░░░░░░  78.5%  ▄▄▄▄▄▄▄▄
    LOAD    1.25 0.89 0.76   Processes: 234
    NETWORK ↑ 1.2GB  ↓ 3.4GB
```

| Metric | Color Threshold | Description |
|--------|----------------|-------------|
| CPU | Green < 60%, Yellow < 80%, Red ≥ 80% | CPU usage with sparkline history |
| Memory | Green < 60%, Yellow < 80%, Red ≥ 80% | RAM usage with used/total GB |
| Disk | Green < 70%, Yellow < 90%, Red ≥ 90% | Disk usage with used/total GB |
| Load | Green < 2.0, Yellow < 4.0, Red ≥ 4.0 | 1/5/15 min load averages |
| Network | N/A | Total bytes sent/received |
...
```
  ...
  TIME              TYPE          ACTION
  ──────────────────  ────────────  ────────────────────────
  2026-07-09 14:32   tool_call     web_search
  2026-07-09 14:31   tool_call     send_message
  2026-07-09 14:30   system        session_start
```
┌── Services ─────────────────────────────────────────────┐
