...
Welcome to the documentation for AetherRavyn. RAVEN is an advanced, multi-agent AI system designed to act as a deeply integrated, omni-present personal companion.
...
Ready to deploy your own JARVIS?
...
-   :material-rocket-launch: __Quick Start__
    ...
    Get up and running with the AetherRavyn CLI and gateway daemon.

    [:octicons-arrow-right-24: Installation Guide](installation.md)

-   :material-server: __Deployment__
...
-   :material-book-open-page-variant: __Architecture__
    ...
    Dive deep into the 8-Layer Stack and cognitive core.

    [:octicons-arrow-right-24: Developer Architecture](developer-architecture.md)

-   :material-api: __Integrations__
