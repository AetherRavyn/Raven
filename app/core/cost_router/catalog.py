...
def _specs() -> list[ModelSpec]:
    ...
    return [
        ...
        ModelSpec(
            ...
            quality={
                TaskType.CHAT: 0.40,
                TaskType.CLASSIFY: 0.45,
                TaskType.EXTRACT: 0.35,
                TaskType.SUMMARIZE: 0.35,
                TaskType.CODE: 0.30,
                TaskType.REASONING: 0.30,
                TaskType.RESEARCH: 0.30,
            },
        ...
        ModelSpec(
            ...
            quality={
                TaskType.CHAT: 0.45,
                TaskType.CLASSIFY: 0.50,
                TaskType.EXTRACT: 0.40,
                TaskType.SUMMARIZE: 0.40,
                TaskType.CODE: 0.35,
                TaskType.REASONING: 0.35,
                TaskType.RESEARCH: 0.35,
            },
            capabilities=frozenset({ModelCapability.STREAMING}),
            max_context=32768,
        ...
        ModelSpec(
            ...
            quality={
                TaskType.CHAT: 0.55,
                TaskType.CLASSIFY: 0.55,
                TaskType.EXTRACT: 0.50,
                TaskType.SUMMARIZE: 0.50,
                TaskType.CODE: 0.48,
                TaskType.REASONING: 0.45,
                TaskType.RESEARCH: 0.45,
            },
            capabilities=frozenset({ModelCapability.STREAMING}),
            max_context=4096,
        ...
        # ------------------------------------------------------------------
        # OpenCode Zen (free cloud gateway — no key needed)
        # ------------------------------------------------------------------
        ModelSpec(
            ...
            quality={
                TaskType.CHAT: 0.72,
                TaskType.CLASSIFY: 0.70,
                TaskType.EXTRACT: 0.70,
                TaskType.SUMMARIZE: 0.68,
                TaskType.CODE: 0.65,
                TaskType.REASONING: 0.65,
                TaskType.RESEARCH: 0.68,
            },
        ...
        ModelSpec(
            ...
            quality={
                ...
                TaskType.CHAT: 0.78,
                TaskType.SUMMARIZE: 0.76,
                TaskType.RESEARCH: 0.75,
                TaskType.EXTRACT: 0.75,
                TaskType.CLASSIFY: 0.75,
            },
            capabilities=cap_code,
        ...
        ModelSpec(
            ...
            quality={
                TaskType.CHAT: 0.72,
                TaskType.SUMMARIZE: 0.70,
                TaskType.EXTRACT: 0.72,
                TaskType.CODE: 0.68,
                TaskType.REASONING: 0.65,
            },
            capabilities=cap_full,
